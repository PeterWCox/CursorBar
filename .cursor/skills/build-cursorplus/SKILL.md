...
- **Output**: `build/Build/Products/Debug/CursorMetro.app`
- Optional: copy to project root with  
  `cp -R build/Build/Products/Debug/CursorMetro.app .`
...
- **Output**: `build/Build/Products/Release/CursorMetro.app`
- Optional: copy to project root with  
  `cp -R build/Build/Products/Release/CursorMetro.app .`
