...
**Cursor Metro** is a lightweight, open-source macOS app that wraps the [Claude Code CLI](https://docs.anthropic.com/en/docs/claude-code/overview) for fast, focused “vibe coding.”
