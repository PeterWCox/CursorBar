...
/// Model options for the Claude Code CLI (id for CLI, label for UI).
enum AvailableModels {
    ...
    static let fallback: [ModelOption] = [
        ...
        ModelOption(id: "sonnet", label: "Sonnet", isPremium: false),
        ModelOption(id: "sonnet[1m]", label: "Sonnet 1M", isPremium: true),
        ModelOption(id: "opus", label: "Opus", isPremium: true),
        ModelOption(id: "opus[1m]", label: "Opus 1M", isPremium: true),
        ModelOption(id: "haiku", label: "Haiku", isPremium: false),
        ModelOption(id: "best", label: "Best Available", isPremium: true),
        ModelOption(id: "claude-sonnet-4-6", label: "Claude Sonnet 4.6", isPremium: false),
        ModelOption(id: "claude-opus-4-6", label: "Claude Opus 4.6", isPremium: true),
    ]
    ...
    static func isPremiumModel(id: String) -> Bool {
        ...
        return !["haiku", "sonnet", "claude-sonnet-4-6"].contains(id)
    }
...
enum AppLimits {
    ...
    /// Approximate token count for context. ~4 chars per token.
